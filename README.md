...
<p align="center">
  <img src="customer_churn_prediction/docs/images/dataset.png" width="80%" alt="Veri Seti Ön İzleme" />
...
<p align="center">
  <img src="customer_churn_prediction/docs/images/smote.png" width="80%" alt="SMOTE ve Veri Dengesizliği" />
...
<p align="center">
  <img src="customer_churn_prediction/docs/images/models.png" width="80%" alt="Modellerin Karşılaştırması" />
...
<p align="center">
  <img src="customer_churn_prediction/docs/images/best-model.png" width="80%" alt="En İyi Modelin Belirlenmesi" />
...
<p align="center">
  <img src="customer_churn_prediction/docs/images/onemli-faktorler.png" width="80%" alt="Özellik Önemi (Feature Importance)" />
...
# 2. Veri setini temizleyerek (.csv) modellemeye hazır matrisi oluşturun (Kök dizinde çalıştırın)
python src/data_preparation.py

# 3. Model eğitimini, SMOTE ile çoğaltmayı ve GridSearchCV aramasını başlatın. 
# En iyi model models klasörüne kaydedilecektir.
